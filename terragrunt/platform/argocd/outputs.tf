...
output "argocd_oidc_client_secret" {
  description = "OIDC client_secret matching what's baked into the Argo CD chart. The downstream services layer creates the matching authentik_provider_oauth2 with this value."
