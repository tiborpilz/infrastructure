...
variable "platform_data_ready" {
  description = "Sentinel from platform-data. Forces this layer to wait until the StorageClass + CNPG operator are present before applying the Cluster CR."
  type        = bool
}
...
variable "storage_class" {
  description = "StorageClass name for the CNPG Cluster's PVC. From platform-data output."
  type        = string
